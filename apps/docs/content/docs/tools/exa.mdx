...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `query` | string | No | Natural language search description for what to find \(e.g.,  |
| `count` | number | No | Number of results to retrieve \(default: 10\) |
| `apiKey` | string | Yes | Exa AI API Key |
...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `websetId` | string | Yes | The webset ID to retrieve |
| `apiKey` | string | Yes | Exa AI API Key |
...
| Parameter | Type | Required | Description |
| --------- | ---- | -------- | ----------- |
| `websetId` | string | Yes | The webset ID to search within |
| `query` | string | Yes | Search query to search within the webset |
| `apiKey` | string | Yes | Exa AI API Key |
...
| ↳ `webset` | json | webset of the response |
