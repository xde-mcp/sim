---
title: Qdrant
description: Use the Qdrant for vector operations
---
...
Store, search, and retrieve vector embeddings using Qdrant.
...
Fetch points by IDs from a Qdrant collection.
...
| Parameter      | Type    | Required | Description                        |
| -------------- | ------- | -------- | ---------------------------------- |
| `operation`    | string  | Yes      | Operation (upsert, search, fetch)  |
